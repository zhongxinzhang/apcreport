...
namespace APCReport
{
    public partial class POForm6 : Form
    {
        public POForm6()
        {
            InitializeComponent();
        ...
        private void POForm6_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            pReport = new Report();
            String reportFile = "Reports/pofastreport6.frx";
        ...
        private void GetData()
        {
            ...
            //实例化SqlCommand
            SqlCommand cmd = new SqlCommand("apc_po_report9", conn);
